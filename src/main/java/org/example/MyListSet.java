...
public class MyListSet<T> extends MyAbstractSet<T> implements Iterable<T> {
    ...
    public static <T> MyListSet<T> of(T... elements) {
        MyListSet<T> result = new MyListSet<>();
...
//        }
//
//        if (!(object instanceof  MyListSet)){
//            return false;
//        }
//
//        MyListSet<T> that = (MyListSet<T>) object;
//
...
//    }
    ...
    @Override
    public boolean  isSubsetOf(MySet<T> that) {
